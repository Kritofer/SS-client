...
MACRO_CONFIG_INT(ClSSClientBotTick, ssc_bot_tick, 12, 0, 30, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Ticks")
MACRO_CONFIG_INT(ClSSClientBotTick1, ssc_bot_tick_hook, 15, 0, 30, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Hook Ticks")
MACRO_CONFIG_INT(ClSSClientBotTick2, ssc_bot_tick_move, 7, 0, 30, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Movement Ticks")
