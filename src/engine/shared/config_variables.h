...
// SSClient_config
MACRO_CONFIG_INT(ClSSClientDebugEnabled, ssc_debug_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Debug Mode")
MACRO_CONFIG_INT(ClSSClientFakePingEnabled, ssc_fakeping_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Fake ping mode")
MACRO_CONFIG_INT(ClSSClientFakePing, ssc_fakeping, 0, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "The amount of fake ping to add")
MACRO_CONFIG_INT(ClSSClientRealPing, ssc_realping, 0, 0, 1000, CFGFLAG_CLIENT, "Your real ping")
MACRO_CONFIG_INT(ClSSClientPredEnabled, ssc_predict_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Prediction")
MACRO_CONFIG_INT(ClSSClientPredTicks, ssc_predict_ticks, 20, 5, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Amount of ticks to predict")
MACRO_CONFIG_INT(ClSSClientEspEnabled, ssc_esp_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Esp")
MACRO_CONFIG_INT(ClSSClientEspDistance, ssc_esp_distance, 800, 100, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Max Esp Distance")
MACRO_CONFIG_INT(ClSSClientBotEnabled, ssc_bot_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Avoid Bot")
MACRO_CONFIG_INT(ClSSClientBotHookEnabled, ssc_bot_hookavoid_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Hook Avoid Bot")
MACRO_CONFIG_INT(ClSSClientBotAimAssistEnabled, ssc_bot_aimassist_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Avoid Bot Aim Assist")
MACRO_CONFIG_INT(ClSSClientBotMoveEnabled, ssc_bot_movementavoid_enabled, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable SSClient Avoid Bot Movement")
MACRO_CONFIG_INT(ClSSClientBotTick, ssc_bot_tick, 12, 0, 60, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Ticks")
MACRO_CONFIG_INT(ClSSClientBotTick1, ssc_bot_tick_hook, 15, 0, 60, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Hook Ticks")
MACRO_CONFIG_INT(ClSSClientBotTick2, ssc_bot_tick_move, 7, 0, 60, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid Bot Movement Ticks")
...
MACRO_CONFIG_INT(ClSSClientFakeVersion, ssc_fakeversion, 19000, 0, 99999, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Changes the client version to be the one defined (CAUTION!) [default = 19000]")
...
MACRO_CONFIG_INT(ClSSClientAimbotAlive, ssc_aimbot_alive, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Makes the aimbot only aim alive tees")
MACRO_CONFIG_INT(ClSSClientAimbotFov, ssc_aimbot_fov, 30, 0, 359, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Fov of the Aimbot")
MACRO_CONFIG_INT(ClSSClientShowColl, ssc_showcoll, 1, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "0 -> Never, 1 -> Others, 2 -> everyone")

MACRO_CONFIG_STR(ClSSClientTasPath, ssc_tas_path, 512, "", CFGFLAG_CLIENT, "Path to save tas")

// Profiles
MACRO_CONFIG_INT(ClApplyProfileSkin, profile_skin, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply skin in profiles")
MACRO_CONFIG_INT(ClApplyProfileName, profile_name, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply name in profiles")
MACRO_CONFIG_INT(ClApplyProfileClan, profile_clan, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply clan in profiles")
MACRO_CONFIG_INT(ClApplyProfileFlag, profile_flag, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply flag in profiles")
MACRO_CONFIG_INT(ClApplyProfileColors, profile_colors, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply colors in profiles")
MACRO_CONFIG_INT(ClApplyProfileEmote, profile_emote, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply emote in profiles")
