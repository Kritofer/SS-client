...
#include "components/SSClient/main.h"
#include "components/SSClient/aimbot.h"
#include "components/SSClient/draw.h"
#include "components/SSClient/profiles.h"
...
int CGameClient::OnSnapInput(int *pData, bool Dummy, bool Force)
{
	...
	if(!g_Config.m_ClDummyHammer)
	{
		...
		if(((!Force && g_Config.m_ClSSClientTasState != 2) && (!m_DummyInput.m_Direction && !m_DummyInput.m_Jump && !m_DummyInput.m_Hook)))
		{
			return 0;
		}
